...
def scheduled_job():
  ...
  reddit = praw.Reddit(
      client_id=os.environ.get("CLIENT_ID_TANK_TWO"),
      client_secret=os.environ.get("SECRET_TOKEN_TANK_TWO"),
      user_agent="funpython2 by u/Tankalele",
  ...
  for submission in reddit.subreddit("satoshistreetbet").hot(limit=10):
      if url_check in submission.url:
        urls.append(submission.url)
